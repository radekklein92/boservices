...
function withdrawalBHtml(): string {
  return `<h2>Smluvní strany</h2><p><strong>{{clientName}}</strong>, IČO: {{clientIco}}, se sídlem {{clientStreet}}, {{clientZip}} {{clientCity}}{{clientRepresentationClause}} (dále jen „<strong>Odesílatel</strong>“)</p><p><strong>{{managerName}}</strong>, IČO: {{managerIco}}, se sídlem {{managerStreet}}, {{managerZip}} {{managerCity}} (dále jen „<strong>Manažer</strong>“)</p><p><strong>{{providerName}}</strong>, IČO: {{providerIco}}, se sídlem {{providerStreet}}, {{providerZip}} {{providerCity}} (dále jen „<strong>Poskytovatel</strong>“)</p><h2>Úvodní prohlášení</h2><ol><li><p>Mezi Smluvními stranami byly dne <strong>{{originContractsDate}}</strong> uzavřeny při témže jednání následující smlouvy, jejichž předmětem je lokace <strong>{{withdrawalLocation}}</strong>:</p><ol><li><p><strong>Smlouva o provozování provozovny</strong> mezi Odesílatelem a Manažerem (dále jen „<strong>MS</strong>“);</p></li><li><p><strong>Franšízingová smlouva</strong> mezi Odesílatelem a Poskytovatelem (dále jen „<strong>FS</strong>“);</p></li><li><p><strong>Kupní smlouva k vybavení</strong> mezi Odesílatelem a Manažerem (dále jen „<strong>KS</strong>“).</p></li></ol></li><li><p>Smlouvy tvoří <strong>jediný hospodářský celek</strong> a jsou ve smyslu <strong>§ 1727 občanského zákoníku</strong> smlouvami závislými.</p></li></ol><h2>Odstoupení</h2><ol><li><p>Poskytovatel dne <strong>{{leaseLostDate}}</strong> pozbyl právní titul, na jehož základě byl povinen přenechat Odesílateli prostory Provozovny do podnájmu podle FS, a v přiměřené době nezajistil náhradní prostory ani jiné rovnocenné plnění.</p></li><li><p>Bez zajištěného provozního prostoru pozbývá FS svého hospodářského účelu.</p></li><li><p>Popsané jednání je <strong>podstatným porušením</strong> smluvní povinnosti ve smyslu § 2002 odst. 1 občanského zákoníku - Odesílatel by Smlouvy neuzavřel, pokud by takový stav v době uzavření Smluv předvídal.</p></li><li><p><strong>Odesílatel tímto odstupuje od Franšízingové smlouvy (FS)</strong> dle <strong>§ 2002 odst. 1 občanského zákoníku</strong>. Odstoupení je účinné okamžikem doručení tohoto projevu vůle (§ 570 odst. 1 OZ).</p></li><li><p>Zároveň podle <strong>§ 1727 občanského zákoníku</strong> dochází k zániku též <strong>Smlouvy o provozování provozovny (MS)</strong>{{ksDropClause}} jako smluv závislých. {{ksPreservedClause}}</p></li><li><p>Pohledávky vzniklé před odstoupením (úroky z prodlení, smluvní pokuty) zůstávají zachovány (§ 2005 odst. 1 OZ).</p></li><li><p>Odesílatel si vyhrazuje veškeré další nároky.</p></li></ol><h2>Podpis</h2><p>V {{place}} dne {{contractDate}}</p><p>&nbsp;</p><p>__________________________<br><strong>{{clientName}}</strong><br>{{clientSignerName}}, {{clientSignerRole}}</p>`;
}
