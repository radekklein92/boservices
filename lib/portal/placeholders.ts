...
export const PLACEHOLDER_GROUPS: PlaceholderGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { token: "{{totalClaimsAmount}}", label: "Celková výše pohledávek (auto ze seznamu)", example: "1 250 000 Kč" },
      { token: "{{claimsTable}}", label: "Příloha č. 1 — tabulka pohledávek (auto)", example: "tabulka se seznamem pohledávek" },
